...
class tag2pix(object):
    ...
    def test(self):
        ...
        with torch.no_grad():
            for sketch_, index_, _, _, cv_tag_ in tqdm(self.test_data_loader, ncols=80):
                if self.gpu_mode:
                ...
                #for ind, result in zip(index_.cpu().numpy(), G_s):
                #    save_path = result_path / f'{ind}_s.png'
                #    torchvision.utils.save_image(result.data, save_path, padding=0)
