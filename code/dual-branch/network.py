...
class Generator(nn.Module):
    def __init__(self, input_size, cv_class_num, iv_class_num, input_dim=1, output_dim=3,
        ...
        self.deconv2 = DecoderBlock(256 + 256 + 128, 4*128, self.color_fc_out, self.layers[1], no_bn=no_bn)
        self.deconv3 = DecoderBlock(128 + 128 + 64, 4*64, self.color_fc_out, self.layers[2], no_bn=no_bn)
        self.deconv4 = DecoderBlock(64 + 64 + 32, 4*32, self.color_fc_out, self.layers[3], no_bn=no_bn)
        self.deconv5 = nn.Sequential(
            nn.Conv2d(32 + 32 + 16, 32, 3, 1, 1),
            nn.LeakyReLU(0.2),
